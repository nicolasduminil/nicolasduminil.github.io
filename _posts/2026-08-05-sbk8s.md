...
tags:
  ...
  - DZone
toc: true
last_modified_at: 2026-08-05T08:05:34-05:00
---
...
All you need to do now is to send a HTTP GET request to the endpoint, as follows:
    ...
    curl http://192.168.49.2:30809/hello/nicolas
    Hello nicolas

As you can see, as a proof a goodwill the endpoint greets you.

You've succeeded to release a Spring Boot application on Kubernetes without
having to write a line of YAML. Congratulations. Now, stay tuned to see what comes next.
